...
import com.turktrust.eticaret.dataAccess.abstracts.Sepet_UrunDao;
...
@Service
public class Sepet_UrunManager implements Sepet_UrunService{
	 private Sepet_UrunDao sepetUrunDao;
    ...
    @Autowired
    public Sepet_UrunManager(Sepet_UrunDao sepetUrunDao, SepetDao sepetDao, UrunDao urunDao, MusteriDao musteriDao, ModelMapperService modelMapperService) {
        super();
